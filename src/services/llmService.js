...
const TRANSLATION_PROMPTS = {
  ...
  retail: {
    // 顾客 → 门店 (问题端 → 方案端)
    customerToStore: {
      systemRole: '你是一个专业的零售需求分析专家，专门将顾客的日常表达转化为门店专业人员能理解的需求描述。',
...
关键要素：产品类型、使用场景、预算范围、尺寸规格、功能需求、风格偏好、时间要求。`,
    ...
    // 门店 → 顾客 (方案端 → 问题端)
    storeToCustomer: {
      systemRole: '你是一个专业的零售沟通优化专家，专门将门店的专业术语和技术描述转化为顾客友好的表达。',
...
关键要素：产品优势、价格性价比、服务承诺、使用效果、购买建议、售后保障。`,
  ...
  enterprise: {
    // 市场部 → 研发部 (问题端 → 方案端)
    marketingToRnD: {
      systemRole: '你是一个专业的企业内部沟通分析专家，专门将市场部的业务需求转化为研发部能理解的技术规格。',
...
关键要素：业务目标、技术需求、性能指标、时间期限、资源预算、成功标准、风险评估。`,
    ...
    // 研发部 → 市场部 (方案端 → 问题端)
    rnDToMarketing: {
      systemRole: '你是一个专业的技术商业化专家，专门将研发部的技术方案转化为市场部能理解的业务价值表达。',
...
关键要素：实施方案、时间安排、资源需求、预期效果、商业价值、风险控制、成本效益。`,
  ...
  education: {
    // 学生 → 教师 (问题端 → 方案端)
    studentToTeacher: {
      systemRole: '你是一个专业的教育沟通分析专家，专门将学生的疑问和困惑转化为教师能系统回答的教学需求。',
...
关键要素：知识点定位、理解困难、学习目标、认知水平、学习方式偏好、实践需求。`,
    ...
    // 教师 → 学生 (方案端 → 问题端)
    teacherToStudent: {
      systemRole: '你是一个专业的教育表达优化专家，专门将教师的专业教学内容转化为学生容易理解和掌握的学习指导。',
